...
data_compl$a_opl_hg = fb_gwr_out$a_opl_hg

coef_fb_gav <- mapview::mapview(data_compl, zcol = "a_opl_hg")
...
data_compl$a_opl_hg = ab_gwr_out$a_opl_hg

coef_ab_gav <- mapview::mapview(data_compl, zcol = "a_opl_hg")
