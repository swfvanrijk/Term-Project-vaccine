...
mc_global <- moran.mc(linearMod$residuals, data_nbq_w, 2999, alternative="greater", zero.policy = TRUE,  adjust.n = TRUE)
...
data_compl$coverage_completed_norm = fb_gwr_out$coverage_completed_norm

coef_fb_gav <- mapview::mapview(data_compl, zcol = "coverage_completed_norm")
...
data_compl$Coverage_primary_completed = ab_gwr_out$Coverage_primary_completed

coef_ab_gav <- mapview::mapview(data_compl, zcol = "Coverage_primary_completed")
