...
mapview::mapview(z_data_compl, zcol = "AfstandTotHuisartsenpraktijk")

mapview::mapview(z_data_compl, zcol = "Vaccination_completely_18", col.regions=brewer.pal(11, "RdYlGn"))
...
data_compl$ft_AfstandTotHuisartsenpraktijk = fb_gwr_out$AfstandTotHuisartsenpraktijk / fb_gwr_out$AfstandTotHuisartsenpraktijk_se

#categorize the t-value to statistical significance
data_compl$ft_AfstandTotHuisartsenpraktijk_cat <- cut(data_compl$ft_AfstandTotHuisartsenpraktijk,
                             breaks=c(min(data_compl$ft_AfstandTotHuisartsenpraktijk), -1.96, 1.96, max(data_compl$ft_AfstandTotHuisartsenpraktijk)),
                             labels=c("sig","nonsig", "sig"))

#plot the significance for fixed kernel model
sig_fb <- mapview::mapview (data_compl, zcol = "ft_AfstandTotHuisartsenpraktijk_cat")
