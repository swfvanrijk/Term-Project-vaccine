...
data_compl$Coverage_primary_completed[which(data_compl$WK_CODE == 'WK036310')] <- NA

qtm(data_compl,'Coverage_primary_completed', fill.palette = brewer.pal(11, "RdYlGn"),borders=NULL, fill.style="fixed", fill.breaks=seq(0,100,10))

tmap_save(filename=paste0(getwd(),"/figures/vac_map.png"))
